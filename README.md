...
- **כפתור Run Process**:
  - הכפתור מפעיל את כל תהליך העיבוד, הכולל:
    - חישוב פרדיקטור.
    - דחיסה באמצעות קידוד האפמן.
    - קידוד ותיקון שגיאות בעזרת CRC והאמינג (או האמינג בלבד, בהתאם להגדרות).
    - הזרקת שגיאות וניתוח שיעור שגיאות לפני ואחרי תיקון.
    - ניתוח והצגת תוצאות חזותיות וכמותיות, כגון יחס דחיסה, BER, וזמן חישוב לפיקסל.
- **כפתור Clear**:
  - מנקה את חלון הלוג.
  - מחזיר את המערכת למצב התחלה ומאפשר עיבוד מחדש.
