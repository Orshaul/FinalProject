...
התמונה מציגה שלוש רמות שונות של עיבוד על פני חמישה ערוצי ספקטרום:
- **מקורית (Original)**: הערוצים המקוריים מתוך התמונה ההיפרספקטרלית.
- **דחוסה (Compressed)**: הפרשים בין הערכים בתמונה המקורית והפרדיקטור, שעברו דחיסה.
- **משוחזרת (Decompressed)**: התמונה ששוחזרה לאחר דחיסה, הזרקת שגיאות, תיקון שגיאות ושחזור.

<p align="center">
<img src="results.png" alt="Example Output of Hyperspectral Processing" width="1000">
</p>

תהליך זה מדגים כיצד האלגוריתם שומר על איכות גבוהה ומסוגל להתמודד עם שגיאות בערוץ, תוך שמירה על יחס דחיסה משביע רצון.
